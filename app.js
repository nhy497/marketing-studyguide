                        ...
                        <div class="col-md-4 mb-3">
                            <div class="form-check form-check-lg">
                                ...
                                <label class="form-check-label ms-2" for="professorBankCheck" style="cursor: pointer;">
                                    ...
                                    <small class="text-muted">57 official exam questions</small>
                                </label>
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    <div class="card border-warning h-100">
                        ...
                        <div class="card-body">
                            <p class="card-text">57 questions directly from professor's formal exam question bank. Actual exam-style questions.</p>
