...
function showQuizQuestion() {
    ...
    // Use English database if available
    if (window.englishQuizQuestions && englishQuizQuestions[currentQuestionIndex]) {
        ...
        questionText = englishQuestion.question;
        optionsText = englishQuestion.options;
        explanationText = englishQuestion.explanation;
    }
    // Use questionEn fields if available
    else if (question.questionEn) {
    ...
    // Fallback to original content (should be English in our new database)
    else {
